...
Instead of geom_point() we use geom_point_interactive() and then use the `girafe()` function to render the plot. The tooltip is set in the aesthetics.

```{r}
library(ggiraph)
gg <- ggplot(iris2, aes(x = Sepal.Length, y = Sepal.Width, tooltip = Species)) +
